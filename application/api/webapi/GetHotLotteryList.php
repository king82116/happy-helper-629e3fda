			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
						...
						$data[0]['state'] = 1;
						$data[0]['sort'] = 0;
						$data[0]['categoryImg'] = 'https://ossimg.bdg123456.com/BDGWin/lotterycategory/lotterycategory_20240321194458iceq.png';
						...
						$data[1]['state'] = 1;
						$data[1]['sort'] = 0;
						$data[1]['categoryImg'] = 'https://ossimg.bdg123456.com/BDGWin/lotterycategory/lotterycategory_20240321194451en5o.png';
						...
						$data[2]['state'] = 1;
						$data[2]['sort'] = 0;
						$data[2]['categoryImg'] = 'https://ossimg.bdg123456.com/BDGWin/lotterycategory/lotterycategory_20240321194510h9i1.png';
						...
						$data[3]['state'] = 1;
						$data[3]['sort'] = 0;
						$data[3]['categoryImg'] = 'https://ossimg.Big-Mumadmin888.com/bigmumbai/lotterycategory/lotterycategory_20230724173608dkuw.png';
