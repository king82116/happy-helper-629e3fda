    ...
    if (isset($shonupost['language']) && isset($shonupost['random']) && isset($shonupost['signature']) && isset($shonupost['timestamp'])) {
        ...
        if ($shonusign != $signature) {
            ...
            if ($data_auth['status'] === 'Success') {
                ...
                if ($sesnum == 1) {
                    $scope5d = get_bet_scope('1|10|100|1000');
                    $scopeK3 = get_bet_scope('5|10|100|1000');
                    $scopeWingoHigh = get_bet_scope('10|50|100|500|1000');
                    $scopeWingoLow = get_bet_scope('5|10|100|1000');
                    ...
                    $dataWingo30sec = [
                        ...
                        'issueNumber' => $wingoRow['atadaaidi'],
                        'startTime' => $wingoRow['dinankavannuracisi'],
                        'endTime' => date('Y-m-d H:i:s', strtotime('+30 seconds', strtotime($wingoRow['dinankavannuracisi']))),
                        'type' => 8,
                        'lotteryName' => 'Wingo 30 Sec',
                        'issue' => 5,
                        'gameType' => 2,
                        'remark' => 'TIE,BIG,SMALL',
                        'gameResult' => 'L',
                    ...
                    $data5D3Min = [
                        ...
                        'issueNumber' => $row5D['atadaaidi'],
                        'startTime' => $row5D['dinankavannuracisi'],
                        'endTime' => date('Y-m-d H:i:s', strtotime('+3 minutes', strtotime($row5D['dinankavannuracisi']))),
                        'type' => 10,
                        'lotteryName' => '5D 3 Min',
                        'issue' => 5,
                        'gameType' => 0,
                        'remark' => 'BIG,SMALL',
                        'gameResult' => 'L',
                    ...
                    $dataWingo3Min = [
                        ...
                        'issueNumber' => $wingoRow['atadaaidi'],
                        'startTime' => $wingoRow['dinankavannuracisi'],
                        'endTime' => date('Y-m-d H:i:s', strtotime('+3 minutes', strtotime($wingoRow['dinankavannuracisi']))),
                        'type' => 11,
                        'lotteryName' => 'Wingo 3 Min',
                        'issue' => 5,
                        'gameType' => 2,
                        'remark' => 'TIE,BIG,SMALL',
                        'gameResult' => 'L',
