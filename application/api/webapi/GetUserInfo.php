			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
                        ...
                        $data['uRate'] = getUsdInrExchangeRate($conn);
						...
						$wagering = computeUserWithdrawalWagering($conn, (int) $data_auth['payload']['id'], (float) $balarr['motta']);
						$data['amountofCode'] = $wagering['amountofCode'];
