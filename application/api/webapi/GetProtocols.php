			...
			if ($data_auth['status'] === 'Success') {
				...
				if ($sesnum == 1) {
					$data['protocols'] = '<div class="content" style="padding: 16px;"><h3 class="text-xs-center" style="box-sizing: inherit; 
						...
						font-weight: bolder;">Company</span>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to<a href="https://joshgame.online" 
						target="_blank">CODEXDR SIKKIM</a>.</font></p></li><li style="box-sizing: inherit; background-repeat: no-repeat; padding: 0px; margin: 0px;"><font color="#ffffff" 
						...
						refers to<a href="https://joshgame.online" target="_blank">CODEXDR SIKKIM</a>, accessible from<a href="https://joshgame.online" 
						target="_blank">CODEXDR SIKKIM</a></font></li><li style="box-sizing: inherit; background-repeat: no-repeat; padding: 0px; margin: 0px;">
