                      ...
                      <tbody>
                        ...
                        if ($result->num_rows > 0) {
                          while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='https://joshgame.online/uploads/" . $row["file_upload"] . "'>" . $row["file_upload"] . "</a></td>";
              ...
              <div class="modal-dialog">
                ...
                <footer class="footer">
                  <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © admin
                      2025</span>
                  </div>
                </footer>
              </div>
