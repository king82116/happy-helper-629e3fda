...
if(isset($_POST['redserial'])){
    ...
    if($exe_ch_s1) {
        ...
        echo '<script type="text/JavaScript"> alert("Deactivation Failed"); </script>';
    }
}
...
if(isset($_POST['delete_id'])){
    ...
    $delete_query = "DELETE FROM demo WHERE balakedara='".$delete_id."'";
...
// Edit Demo User
if(isset($_POST['edit_id']) && isset($_POST['new_mobile']) && isset($_POST['new_password'])){
    $edit_id = $_POST['edit_id'];
    $new_mobile = mysqli_real_escape_string($conn, $_POST['new_mobile']);
    $new_password = mysqli_real_escape_string($conn, $_POST['new_password']);
    
    // Update demo table
    $update_demo = "UPDATE demo SET motta='".$new_mobile."' WHERE balakedara='".$edit_id."'";
    $demo_result = mysqli_query($conn, $update_demo);
    
    // Update shonu_subjects table
    $update_user = "UPDATE shonu_subjects SET mobile='".$new_mobile."', password='".md5($new_password)."', pwd='".$new_password."' WHERE id='".$edit_id."'";
    $user_result = mysqli_query($conn, $update_user);
    
    if($demo_result && $user_result) {
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">                    
            <?php
                $sel_red = "SELECT d.*, s.mobile, s.pwd FROM demo d JOIN shonu_subjects s ON d.balakedara = s.id WHERE d.sthiti='1'";
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="action-buttons">
                            ...
                            <button type="button" class="btn btn-warning btn-sm action-btn" data-toggle="modal" data-target="#editModal<?php echo $row['balakedara']; ?>">
                                Edit
                            </button>
                            
                            <!-- Delete Form -->
                            <form method="post" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                <input type="hidden" name="delete_id" value="<?php echo $row['balakedara']; ?>">
                            ...
                            <!-- Edit Modal -->
                            <div class="modal fade" id="editModal<?php echo $row['balakedara']; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="post">
                                            <div class="modal-body">
                                                <input type="hidden" name="edit_id" value="<?php echo $row['balakedara']; ?>">
                                                <div class="form-group">
                                                    <label for="new_mobile">Mobile Number</label>
                                                    <input type="text" class="form-control" id="new_mobile" name="new_mobile" value="<?php echo $row['mobile']; ?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="new_password">Password</label>
                                                    <input type="text" class="form-control" id="new_password" name="new_password" value="<?php echo $row['pwd']; ?>" required>
                                                </div>
                                            </div>
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Prime Tech With Rohit</span>
          </div>
        </footer>
      </div>
    </div>
