    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
            <?php
                $sel_upi = "SELECT * FROM images WHERE status='0' OR status='1' ORDER BY status DESC";
            ...
            ?>
                    <div class="image-container">
                        <img src="<?php echo $image_path; ?>" alt="UPI Image" class="image-preview">
                        <div>
                            <input name="upiid" type="radio" value="<?php echo $row['filename']; ?>" <?php if($row['status']==1){echo "checked";} ?> />
                            <label for="<?php echo $row['filename']; ?>"><?php echo $row['filename']; ?></label>
                        </div>
                        <div class="image-actions">
                            <button type="submit" name="delete_image" value="<?php echo $row['id']; ?>" class="btn btn-danger cool-button" onclick="return confirm('Are you sure you want to delete this image?')">Delete</button>
                        </div>
                    </div>
            <?php   
                }
            ?>
                    ...
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-primary cool-button mr-2" style="margin-top: 10px; margin-left:12px;">Save Selection</button>
                    </div>
                </form>
          </div>                              
        </div>
