				...
				<form id="formID" name="formID" method="post" action="#" enctype="multipart/form-data">
					<table id="example1" class="table table-bordered table-striped">
						...
						<?php
							...
							from `hintegedukolli` where `sthiti` IN ('0','3') order by shonu desc");
							$i=0;
							$total=0; 
						...
						?>  
								<tr>
									...
									<td><?php echo $row['sthiti'] == '3' ? '<span style="color:#e6a700;font-weight:bold;">Processing</span>' : '<span style="color:#dc3545;font-weight:bold;">Pending</span>'; ?></td>
									<td><a href="withdrawal-accept-reject.php?id=<?php echo $row['shonu']; ?>" data-toggle="tooltip" title="Update Withdraw"><i class="fa fa-eye" style="font-size:20px;"></i></a></td>
								</tr>
						<?php 
							}
						?>
