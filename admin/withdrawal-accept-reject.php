        ...
        <div class="content-wrapper">
		  ...
		  <div class="row">
			...
			<div class="col-sm-12">
				<?php if ($Result['sthiti'] == 0) { ?>
						<div class="d-flex flex-wrap">
						  <div class="col-sm-4 mb-2">
							<a href="javascript:void(0);" class="btn btn-warning btn-block" onClick="acceptrejectconfirm(<?php echo $Result['shonu']; ?>,'processing');">
							  <strong><i class="fa fa-spinner"></i> Processing</strong>
							</a>
						  </div>
						  <div class="col-sm-4 mb-2">
							<a href="javascript:void(0);" class="btn btn-success btn-block" onClick="acceptrejectconfirm(<?php echo $Result['shonu']; ?>,'accept');">
							  <strong><i class="fa fa-check"></i> Complete</strong>
							</a>
						  </div>
						  <div class="col-sm-4 mb-2">
				...
				<?php } elseif ($Result['sthiti'] == 3) { ?>
						<div class="d-flex flex-wrap">
						  <div class="col-sm-6 mb-2">
							<a href="javascript:void(0);" class="btn btn-success btn-block" onClick="acceptrejectconfirm(<?php echo $Result['shonu']; ?>,'accept');">
							  <strong><i class="fa fa-check"></i> Proceed / Success</strong>
							</a>
						  </div>
						  <div class="col-sm-6 mb-2">
							<a href="javascript:void(0);" class="btn btn-danger btn-block" onClick="acceptrejectconfirm(<?php echo $Result['shonu']; ?>,'reject');">
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                if (html == 1) {
                    ...
                    window.location = 'manage_withdraw.php?msg=processing';
                } else {
