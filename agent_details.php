<script>
	if (!localStorage.getItem('userInfo')) {
		window.location.href = 'https://joshgame.online/#/login';
	}
	else {
		...
		fetch('get_agent.php', {
			...
			.then(data => {
				if (data.res != '1') {
					window.location.href = 'https://joshgame.online/';
				}
				else {
					let date = new Date();
						...
						<div class="modal-content">
							...
							<form name="type" id="typea" enctype="multipart/form-data" action="#" method="post">
								<div class="modal-body">
									<div class="form-group ">
										<label for="add_item">Amount</label>
										<input class="form-control" id="amounta" name="amount" type="text" value=""
											onkeypress="return isNumber(event)" required>
